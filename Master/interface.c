...
char* serializar_item_reduccion_local(item_reduccion_local* item_reduccion_local){
	...
	serializarDato(serializedPackage,&(item_reduccion_local->ip_puerto_worker),sizeof(char[20]),&offset);
...
uint32_t getLong_one_item_reduccion_local(item_reduccion_local* items_reduccion_local){
	uint32_t longitud = 0;
	longitud += sizeof(uint32_t); //nodo_id
	longitud += sizeof(char[20]); //ip_puerto_worker,
...
item_reduccion_local* deserializar_item_reduccion_local(char* serialized){
	...
	deserializarDato(&(itemReduccionLocal->ip_puerto_worker),serialized,sizeof(char[20]),&offset);
...
void agregarItemReduccionLocal(solicitud_reduccion_local* solicitudReduccionLocal, item_reduccion_local* item){
	...
	strcpy(solicitudReduccionLocal->items_reduccion_local[solicitudReduccionLocal->item_cantidad].ip_puerto_worker,item->ip_puerto_worker);
...
void testSerializarSolicitudReduccionLocal(){
	...
	for (var2 = 0; var2 < solicitudRedLocalDeserializada->item_cantidad; ++var2) {
		...
		printf("ip_puerto_worker = %s\n", solicitudRedLocalDeserializada->items_reduccion_local[var2].ip_puerto_worker );
	}
}
...
char* serializar_item_reduccion_global(item_reduccion_global* item_reduccion_global){
	...
	serializarDato(serializedPackage,&(item_reduccion_global->ip_puerto_worker),sizeof(char[20]),&offset);
...
item_reduccion_global* deserializar_item_reduccion_global(char* serialized){
	...
	deserializarDato(&(itemReduccionGlobal->ip_puerto_worker),serialized,sizeof(char[20]),&offset);
...
void agregarItemReduccionGlobal(solicitud_reduccion_global* solicitudReduccionGlobal, item_reduccion_global* item){
	...
	strcpy(solicitudReduccionGlobal->items_reduccion_global[solicitudReduccionGlobal->item_cantidad].ip_puerto_worker,item->ip_puerto_worker);
...
void testSerializarSolicitudReduccionGlobal(){
	...
	for (var2 = 0; var2 < solicitudRedGlobalDeserializada->item_cantidad; ++var2) {
		...
		printf("ip_puerto_worker = %s\n", solicitudRedGlobalDeserializada->items_reduccion_global[var2].ip_puerto_worker );
...
char* serializarSolicitudAlmacenadoFinal(solicitud_almacenado_final* solicitudAlmacenadoFinal){
	...
	serializarDato(serializedPackage,&(solicitudAlmacenadoFinal->ip_puerto_worker),sizeof(char[20]),&offset);
...
solicitud_almacenado_final* deserializar_solicitud_almacenado_final(char* serialized){
	...
	deserializarDato(&(solicitudAlmacenadoFinal->ip_puerto_worker),serialized,sizeof(char[20]),&offset);
...
void testSerializarSolicitudAlmacenadoFinal(){
	...
	printf("ip_puerto_worker = %s\n", solicitudDeserializado->ip_puerto_worker );
}
