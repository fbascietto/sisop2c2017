...
uint32_t getLong_SolicitudProgramaReduccionGlobal(solicitud_programa_reduccion_global* solicitud){
	...
	uint32_t size_items = getLong_items_prog_reduccion_global(solicitud->items_programa_reduccion_global,solicitud->cantidad_item_programa_reduccion);
...
char* serializar_items_prog_reduccion_global(item_programa_reduccion_global** items_programa_reduccion_global, uint32_t cantidad_item){
	...
	uint32_t total_size = getLong_items_prog_reduccion_global(aux_items_programa_reduccion_global, cantidad_item);
	char *serializedPackage = malloc(sizeof(char)*total_size);
	...
	for (i = 0; i < cantidad_item; i++) {
		...
		uint32_t size_item = getLong_one_item_prog_reduccion_global(&aux_items_programa_reduccion_global[i]);
